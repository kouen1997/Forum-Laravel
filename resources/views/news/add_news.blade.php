            ...
            <div class="col-md-12">
              <div class="card bg-boxshadow mb-3">
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ url('/news/add') }}" enctype='multipart/form-data' id="addForm">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="cover_image" class="form-control cover_image" id="cover_image" placeholder="Cover Image" required>
                            <output id="image_preview"></output>
                        </div>
                        <div class="form-group">
