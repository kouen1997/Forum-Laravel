  ...
  <div class="profile">
    <div class="profile-header">
      ...
      <ul class="profile-header-tab nav nav-tabs">
        ...
        <li class="nav-item"><a href="#profile-bdo-account" class="nav-link" data-toggle="tab">BDO ACCOUNT</a></li>
        @if($user->bdo)
    ...
    <div class="panel-body">
      <div class="profile-content">
          <div class="tab-content p-0">
            <div class="tab-pane fade show active" id="profile-dashboard">
              <div class="row">
                <div class="col-lg-4 col-md-6">
                  <div class="widget widget-stats bg-gradient-grey">
                    <div class="stats-content">
                      <div class="stats-title text-dark">Rewards Wallet</div>
                      <div class="stats-number"><span class="text-primary">&#8369;{{ $ecomnnect_wallet }}</span></div>
                      <div class="stats-progress progress bg-black-transparent-5">
                        <div class="progress-bar bg-white" style="width: 0%;"></div>
                      </div>
                      <div class="stats-desc text-white">total accumulated points (signup/video tutorial)</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6">
                  <div class="widget widget-stats bg-gradient-grey">
                    <div class="stats-content">
                      <div class="stats-title text-dark">E-Wallet Balance</div>
                      <div class="stats-number"><span class="text-primary">&#8369;<span ng-bind="data.earnings.available_wallet | number:0"></span></div>
                      <div class="stats-progress progress bg-black-transparent-5">
                        <div class="progress-bar bg-white" style="width: 0%;"></div>
                      </div>
                      <div class="stats-desc text-white">total balance in e-wallet</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6">
                  <div class="widget widget-stats bg-gradient-grey">
                    <div class="stats-content">
                      <div class="stats-title text-dark">Video Tutorial / Signup Rewards</div>
                      <div class="stats-number"><span class="text-primary">&#8369;<span ng-bind="data.earnings.watch_bonus | number:0"></span> / <span ng-bind="data.earnings.signup_bonus | number:0"></span></div>
                      <div class="stats-progress progress bg-black-transparent-5">
                        <div class="progress-bar bg-white" style="width: 0%;"></div>
                      </div>
                      <div class="stats-desc text-white">total video tutorial & sign up rewards</div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="widget widget-stats bg-gradient-red">
                    <div class="stats-content">
                      <div class="stats-title text-dark">Commission Withdrawn</div>
                      <div class="stats-number"><span class="text-white">&#8369;<span ng-bind="data.earnings.total_withdrawal | number:0"></span></span></div>
                      <div class="stats-progress progress bg-black-transparent-5">
                        <div class="progress-bar bg-white" style="width: 0%;"></div>
                      </div>
                      <div class="stats-desc text-white">total withdrawn from e-wallet</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 col-md-6">
                  <div class="widget widget-stats bg-gradient-lime">
                    <div class="stats-content">
                      <div class="stats-title text-dark">Commission Earned</div>
                      <div class="stats-number"><span class="text-white">&#8369;<span ng-bind="data.earnings.total_earnings | number:0"></span></span></div>
                      <div class="stats-progress progress bg-black-transparent-5">
                        <div class="progress-bar bg-white" style="width: 0%;"></div>
                      </div>
                      <div class="stats-desc text-white">total commission earned</div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-4 col-md-6">
                  <div class="widget widget-stats bg-gradient-grey">
                    <div class="stats-content">
                      <div class="stats-title text-dark">Direct Sales Commission</div>
                      <div class="stats-number"><span class="text-primary">&#8369;<span ng-bind="data.earnings.sponsored_bonus | number:0"></span></span></div>
                      <div class="stats-progress progress bg-black-transparent-5">
                        <div class="progress-bar bg-white" style="width: 0%;"></div>
                      </div>
                      <div class="stats-desc text-white">total direct sales commission</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6">
                  <div class="widget widget-stats bg-gradient-grey">
                    <div class="stats-content">
                      <div class="stats-title text-dark">Sales Match Commission</div>
                      <div class="stats-number"><span class="text-primary">&#8369;<span ng-bind="data.earnings.total_pairing_bonus | number:0"></span></div>
                      <div class="stats-progress progress bg-black-transparent-5">
                        <div class="progress-bar bg-white" style="width: 0%;"></div>
                      </div>
                      <div class="stats-desc text-white">total sales match commission</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6">
                  <div class="widget widget-stats bg-gradient-grey">
                    <div class="stats-content">
                      <div class="stats-title text-dark">Overriding Sales Commission</div>
                      <div class="stats-number"><span class="text-primary">&#8369; <span ng-bind="data.earnings.total_leveling_bonus | number:0"></span></div>
                      <div class="stats-progress progress bg-black-transparent-5">
                        <div class="progress-bar bg-white" style="width: 0%;"></div>
                      </div>
                      <div class="stats-desc text-white">total overriding sales match commission</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="tab-pane fade" id="profile-bdo-account">
              <form class="ng-pristine ng-valid-email ng-invalid ng-invalid-required" name="bdoAccountFrm" ng-submit="frm.bdoAccount(bdoAccountFrm.$valid)" autocomplete="off">
                <div class="row p-4 m-t-20">
                  <div class="col-md-6 offset-md-3">
                    <div class="form-group">
                        <label>Bank Account Number <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="E.g. 00123456789" name="bank_account" id="bank_account" ng-model="frm.bank_account" ng-init="frm.bank_account='{{ $user->bdo->bank_account }}'">
                    </div>
                  </div>
                  <div class="col-md-6 offset-md-3">
                    <div class="form-group">
                        <label>Cash Card Account Number <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="E.g. 521090575564952" name="cash_card_account" id="cash_card_account" ng-model="frm.cash_card_account" ng-init="frm.cash_card_account='{{ $user->bdo->cash_card_account != NULL ? $user->bdo->cash_card_account : ''  }}'">
                    </div>
                  </div>
                  <div class="col-md-12 m-t-15 text-center">
                    <button type="submit" ng-disabled="bdoAccountFrm.$invalid" id="bdo_account_btn" class="btn btn-danger">Save</button>
                  </div>
                </div>
              </form>
            </div>
...
<script type="text/javascript">
    ...
    $('span[id^="default-loading"]').show();
    $('span[id^="value"]').hide();
    $('small[id^="value"]').hide();
    $('span[id^="peso_sign"]').hide();
    ...
    (function () {
        ...
        dashboardApp.controller('DashboardCtrl', function ($scope, $http, $sce) {
            ...
            $http.get('/admin/members/'+user_id+'/data').success(function (data) {
   
                $('span[id^="default-loading"]').hide();
                $('span[id^="peso_sign"]').show();
                $('span[id^="value"]').show();
                $('small[id^="value"]').show();
                $scope.data = data;
            ...
            vm.updateInfo = function () {
              ...
              $http({
                    method: 'POST',
                    url: '/admin/members/'+user_id+'/profile',
                    data: JSON.stringify({
            ...
            vm.changePassword = function () {
              ...
              $http({
                    method: 'POST',
                    url: '/admin/members/'+user_id+'/password',
                    data: JSON.stringify({
            ...
            vm.changeSponsor = function () {

              $http({
                    method: 'POST',
                    url: '/admin/members/'+user_id+'/sponsor',
                    data: JSON.stringify({
                       new_sponsor: vm.new_sponsor
                    })
                }).success(function (data) {
                    if (data.result==1){
            ...
            vm.bdoAccount = function () {

              $http({
                    method: 'POST',
                    url: '/admin/members/'+user_id+'/bdo_account',
                    data: JSON.stringify({
                       bank_account: vm.bank_account,
                       cash_card_account: vm.cash_card_account
            ...
            vm.yazzAccount = function () {
              ...
              $http({
                    method: 'POST',
                    url: '/admin/members/'+user_id+'/yazz_account',
                    data: JSON.stringify({
            ...
            vm.changeMaxAttempt = function () {
              ...
              $http({
                    method: 'POST',
                    url: '/admin/members/'+user_id+'/bdo_attempt',
                    data: JSON.stringify({
