                ...
                <div class="card bg-boxshadow mb-3">
                    <div class="card-body">
                        ...
                        <div class="col-md-6 offset-md-3">
                            <form method="POST" action="{{ url('admin/property/add') }}" autocomplete="off" accept-charset="utf-8" enctype="multipart/form-data" id="addForm">
                                {!! csrf_field() !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="mobile" value="{{ old('mobile') }}" placeholder="Phone">
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="form-group mt-3">
                                            <small class="text-danger">*max of 10 images</small>
                                        </div>
                                        <div class="form-group">
