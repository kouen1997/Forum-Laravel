                ...
                <div class="card bg-boxshadow mb-3">
                    <div class="card-body">
                        ...
                        <div class="col-md-6 offset-md-3">
                            <form method="POST" action="{{ url('/admin/property/'.$property->id.'/edit') }}" autocomplete="off" accept-charset="utf-8" enctype="multipart/form-data" id="editForm">
                                {!! csrf_field() !!}
        ...
        propertyApp.controller('PropertyCtrl', function ($scope, $http, $sce) {
            ...
            frm.submit(function (e) {
                ...
                var image_id = document.getElementById("image_id").value;
                 ...
                 $.ajax({
                    type: 'POST',
                    url: '/admin/property/image/'+image_id+'/delete',
                    data: frm.serialize()
                }).done(function(data) {
