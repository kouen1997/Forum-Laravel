...
@section('title', 'Retail Orders Delivery')
...
<div ng-app="productInventoryApp" ng-controller="ProductInventoryCtrl as frm">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Retail Orders Delivery</li>
    </ol>
    <h1 class="page-header">Retail Orders  Delivery</h1>
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Retail Order List</h4>
        </div>
                ...
                <table class="table table-striped table-bordered" id="content-table" width="100%" style="display: none">
                    ...
                    <tbody>
                        <tr ng-repeat="order in data.orders" class="middle text-center">
                            ...
                            <td>
                                <img ng-if="order.receipt!=NULL" ng-src="@{{order.receipt}}" class="img img-responsive img-thumbnail text-center  center-block" style="height: 100px;margin:0 auto;">
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <a ng-if="order.mode=='DELIVERY'" href="{{ url('/helper/product-inventory/history') }}/@{{order.id}}/receipt" class="btn btn-xs btn-primary" target="_blank">Upload Receipt</a>
    ...
    (function () {
        ...
        productInventoryApp.controller('ProductInventoryCtrl', function ($scope, $http, $sce) {
            ...
            function getdata() {
                ...
                $http.get('/helper/product-inventory/retail/orders-delivery-data').success(function (data) {
                    $scope.data = data;
