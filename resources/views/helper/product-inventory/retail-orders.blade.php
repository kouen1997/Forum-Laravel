...
@section('title', 'Retail Orders Pickup')
...
<div ng-app="productInventoryApp" ng-controller="ProductInventoryCtrl as frm">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Retail Orders Pickup</li>
    </ol>
    <h1 class="page-header">Retail Orders Pickup</h1>
    ...
    (function () {
        ...
        productInventoryApp.controller('ProductInventoryCtrl', function ($scope, $http, $sce) {
            ...
            function getdata() {
                ...
                $http.get('/helper/product-inventory/retail/orders-data').success(function (data) {
                    $scope.data = data;
