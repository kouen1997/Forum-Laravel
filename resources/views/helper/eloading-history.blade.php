...
@section('title', 'Eloading History | Helper')
                                ...
                                <tr ng-repeat="history in data.transfer_history" class="middle text-center">
                                    ...
                                    <td>
                                        <span ng-if="history.transfer_by_user_id == {{$user->id}}">
                                            You transferred <strong class="text-danger">&#8369; @{{ history.amount }}</strong> load wallet to @{{history.transfer_to.username}}
                                        </span>
                                        <span ng-if="history.transfer_to_user_id == {{$user->id}}">
                                            You received <strong class="text-danger">&#8369; @{{ history.amount }}</strong> load wallet from  @{{history.transfer_by.username}}
                                        </span>
                                    </td>
                                    <td><strong class="text-danger">&#8369; @{{ history.total }}</strong></td>
                                    <td>@{{ history.created_at }}</td>
                                    <td>
                                        <button class="btn btn-primary btn-sm"  ng-click="frm.retrieveFund(history.id)" >Retrieve</button>
                                    </td>
                                </tr>
                          </tbody>
                        </table>
