                ...
                <div class="card bg-boxshadow mb-3">
                    <div class="card-body">
                        ...
                        <div class="col-md-6 offset-md-3">
                            <form method="POST" action="{{ url('/profile/property/add') }}" autocomplete="off" accept-charset="utf-8" enctype="multipart/form-data" id="addForm">
                                {!! csrf_field() !!}
            ...
            vm.add = function () {
                ...
                $http({
                    ...
                    if (data.result == 1){
                        ...
                        setTimeout(window.location.href = '/profile/property/add', 10000);
