...
@section('content')
<div ng-app="accountActivationApp" ng-controller="AccountActivationCtrl as frm">
    <div class="col-12 mb-3">
        <div class="card bg-boxshadow full-height">
            <div class="card-body">
                <h4 class="card-title">Activate your account</h4>
                <form class="ng-pristine ng-valid-email ng-invalid ng-invalid-required" name="addAccountFrm" ng-submit="frm.submitAddAccount(addAccountFrm.$valid)" autocomplete="off">
                    <p class="lead semi-bold m-b-15">please double check before activating</p>
                    <hr>
                    ...
                    @if($user->account()->count() < 15 )
                        ...
                        ?>
                        @if($settings == "true")
                            <button type="submit" ng-disabled="addAccountFrm.$invalid" id="add_account_btn" class="btn btn-md btn-primary m-r-5 m-b-15">Activate</button>
                        @else
...
<script type="text/javascript">
	(function () {
        ...
        var accountActivationApp = angular.module('accountActivationApp', ['angular.filter']);
        accountActivationApp.controller('AccountActivationCtrl', function ($scope, $http, $sce) {
